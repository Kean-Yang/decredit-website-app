...
import Success from '../../assets/com/success.png';
            ...
            <div className="authorizatio">
                ...
                <div className="content">
                    ...
                    <div className="content-content">
                        <img src={Success as any} alt="OpenDefi" />
                        <span>{t('AuthorizationSuccess')}</span>
                    </div>
                    <a
...
export default AuthorizatioSucces;
