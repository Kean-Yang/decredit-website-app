...
export async function sendTransaction (transactionParameters, pendding, resFun, errFun, transaction = false, cancelFun) {
    try {
...
export async function getTransactionReceiptPromise (txHash) {
    try {
        return new Promise(((resolve, reject) => {
            Contract.eth.getTransactionReceipt(txHash, function (err, data) {
